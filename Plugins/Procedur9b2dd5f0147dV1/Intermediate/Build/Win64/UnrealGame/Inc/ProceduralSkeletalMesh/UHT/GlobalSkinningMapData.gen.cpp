...
#include "ProceduralSkeletalMesh/Public/GlobalSkinningMapData.h"
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_GlobalSkinningMapData;
class UScriptStruct* FGlobalSkinningMapData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGlobalSkinningMapData, (UObject*)Z_Construct_UPackage__Script_ProceduralSkeletalMesh(), TEXT("GlobalSkinningMapData"));
	}
	return Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.OuterSingleton;
}
template<> PROCEDURALSKELETALMESH_API UScriptStruct* StaticStruct<FGlobalSkinningMapData>()
{
	return FGlobalSkinningMapData::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.InnerSingleton, Z_Construct_UScriptStruct_FGlobalSkinningMapData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_GlobalSkinningMapData.InnerSingleton;
}
// End ScriptStruct FGlobalSkinningMapData

// Begin Registration
struct Z_CompiledInDeferFile_FID_TheMutantIsland_Plugins_Procedur9b2dd5f0147dV1_Source_ProceduralSkeletalMesh_Public_GlobalSkinningMapData_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FGlobalSkinningMapData::StaticStruct, Z_Construct_UScriptStruct_FGlobalSkinningMapData_Statics::NewStructOps, TEXT("GlobalSkinningMapData"), &Z_Registration_Info_UScriptStruct_GlobalSkinningMapData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGlobalSkinningMapData), 2912048588U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TheMutantIsland_Plugins_Procedur9b2dd5f0147dV1_Source_ProceduralSkeletalMesh_Public_GlobalSkinningMapData_h_2649833210(TEXT("/Script/ProceduralSkeletalMesh"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_TheMutantIsland_Plugins_Procedur9b2dd5f0147dV1_Source_ProceduralSkeletalMesh_Public_GlobalSkinningMapData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TheMutantIsland_Plugins_Procedur9b2dd5f0147dV1_Source_ProceduralSkeletalMesh_Public_GlobalSkinningMapData_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
